...
const (
	DTokenCfgName = "dToken" // Global configuration node name for dToken 全局配置文件中 dToken 节点名称
	...
	CacheModeFileDat = "dtoken.dat" // Default file storage for cache 缓存文件的默认存储名称
